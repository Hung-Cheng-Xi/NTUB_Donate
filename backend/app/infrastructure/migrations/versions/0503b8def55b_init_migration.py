...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "res_address", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column(
            "registered_address",
            sqlmodel.sql.sqltypes.AutoString(),
        ...
        sa.Column(
            "public_status",
            sa.Enum("PUBLIC", "ANONYMOUS", "PARTIALLY", name="pubicstatus"),
            nullable=False,
        ),
        sa.Column("memo", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
        ...
        sa.Column(
            "type",
            sa.Enum("STORE", "BANK", name="donationtype"),
            nullable=False,
        ),
        sa.Column(
            "transaction_id", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
    ...
    connection.execute(
        ...
        [
            {
                "id": i,
                "title": f"Donation Law {i}",
                "category": "COMMERCIAL_LAW",
                "description_link": f"http://example.com/donation-law-{i}",
                "is_show": True,
            }
            for i in range(1, 6)
        ],
    ...
    connection.execute(
        ...
        [{"id": i, "name": f"Unit {i}"} for i in range(1, 6)],
    )
    ...
    connection.execute(
        ...
        [{"id": i, "account": f"user{i}"} for i in range(1, 6)],
    )
        ...
        [
            {
                ...
                "description": f"This is announcement {i}.",
                "is_show": True,
                "unit_id": 1,
            }
            for i in range(1, 6)
        ...
        [
            {
                ...
                "title": f"Purpose {i}",
                "lump_sum": 5000 * i,
                "description": f"Purpose description {i}",
                "memo": f"Memo {i}",
                "is_show": True,
                "unit_id": 1,
            }

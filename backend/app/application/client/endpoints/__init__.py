...
client_router.include_router(
    donation_router, prefix="/donation", tags=["Client - Donation"]
)
...
client_router.include_router(
    announcement_router, prefix="/announcement", tags=["Client - Announcement"]
)

client_router.include_router(
    document_router, prefix="/regulation", tags=["Client - Regulation"]
)

client_router.include_router(
    barcode_router, prefix="/barcode", tags=["Client - Barcode"]
)

client_router.include_router(
    address_router, prefix="/address", tags=["Client - Address"]
)
